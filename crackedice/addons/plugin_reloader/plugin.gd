...
const ReloaderScene: PackedScene = preload("res://addons/plugin_reloader/internal/reloader.tscn")
const Reloader := preload("res://addons/plugin_reloader/internal/reloader.gd")
